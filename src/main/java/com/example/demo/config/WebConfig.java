...
import com.example.demo.filter.AdminRoleFilter;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    // TODO: 2. 인가에 대한 이해
    private static final String[] AUTH_REQUIRED_PATH_PATTERNS = {"/admins/*", "/items/*"};
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        // AuthInterceptor는 /users 경로에 대해 적용하지 않도록 예외 처리됨
    ...
    public FilterRegistrationBean authFilter() {
        ...
        filterRegistrationBean.addUrlPatterns("/users/logout");
        return filterRegistrationBean;
    }

    @Bean(name = "userRoleFilterBean")
    ...
    @Bean(name = "adminRoleFilterBean")
    public FilterRegistrationBean adminRoleFilter() {
        FilterRegistrationBean<AdminRoleFilter> filterRegistrationBean = new FilterRegistrationBean<>();
        filterRegistrationBean.setFilter(new AdminRoleFilter());
